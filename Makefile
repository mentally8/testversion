#############################################################################
# Makefile for building: vaultcoin-qt
# Generated by qmake (2.01a) (Qt 4.8.4) on: Mon Aug 4 15:03:34 2014
# Project:  vaultcoin-qt.pro
# Template: app
# Command: /usr/lib/x86_64-linux-gnu/qt4/bin/qmake -o Makefile vaultcoin-qt.pro
#############################################################################
...
SOURCES       = src/qt/vaultcoin.cpp \
		src/qt/vaultcoingui.cpp \
		...
		src/jh.c \
		src/keccak.c \
		src/skein.c build/moc_vaultcoingui.cpp \
		...
		build/moc_vaultcoinaddressvalidator.cpp \
		...
		build/moc_vaultcoinamountfield.cpp \
		...
		qrc_vaultcoin.cpp
OBJECTS       = build/vaultcoin.o \
		build/vaultcoingui.o \
		...
		build/vaultcoinaddressvalidator.o \
		build/alert.o \
		build/version.o \
		build/sync.o \
		build/util.o \
		...
		build/vaultcoinstrings.o \
		build/vaultcoinamountfield.o \
		build/wallet.o \
		build/keystore.o \
		build/transactionfilterproxy.o \
		build/transactionview.o \
		build/walletmodel.o \
		build/vaultcoinrpc.o \
		build/rpcdump.o \
		build/rpcnet.o \
		build/rpcmining.o \
		build/rpcwallet.o \
		...
		build/moc_vaultcoinaddressvalidator.o \
		...
		build/moc_vaultcoinamountfield.o \
...
$(TARGET): /home/luke/Downloads/VaultCoin/build/build.h build/ui_sendcoinsdialog.h build/ui_addressbookpage.h build/ui_signverifymessagedialog.h build/ui_aboutdialog.h build/ui_editaddressdialog.h build/ui_transactiondescdialog.h build/ui_overviewpage.h build/ui_sendcoinsentry.h build/ui_askpassphrasedialog.h build/ui_rpcconsole.h build/ui_optionsdialog.h $(OBJECTS)  
	$(LINK) $(LFLAGS) -o $(TARGET) $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: vaultcoin-qt.pro  /usr/share/qt4/mkspecs/linux-g++-64/qmake.conf /usr/share/qt4/mkspecs/common/unix.conf \
		/usr/share/qt4/mkspecs/common/linux.conf \
		/usr/share/qt4/mkspecs/common/gcc-base.conf \
		/usr/share/qt4/mkspecs/common/gcc-base-unix.conf \
		/usr/share/qt4/mkspecs/common/g++-base.conf \
	...
	$(QMAKE) -o Makefile vaultcoin-qt.pro
...
dist: 
	@$(CHK_DIR_EXISTS) build/vaultcoin-qt1.0.0 || $(MKDIR) build/vaultcoin-qt1.0.0 
	$(COPY_FILE) --parents $(SOURCES) $(DIST) build/vaultcoin-qt1.0.0/ && $(COPY_FILE) --parents src/qt/locale/vaultcoin_en.ts src/qt/locale/vaultcoin_ru.ts build/vaultcoin-qt1.0.0/ && $(COPY_FILE) --parents src/qt/vaultcoingui.h src/qt/transactiontablemodel.h src/qt/addresstablemodel.h src/qt/optionsdialog.h src/qt/sendcoinsdialog.h src/qt/addressbookpage.h src/qt/signverifymessagedialog.h src/qt/aboutdialog.h src/qt/editaddressdialog.h src/qt/vaultcoinaddressvalidator.h src/alert.h src/addrman.h src/base58.h src/bignum.h src/checkpoints.h src/compat.h src/sync.h src/util.h src/uint256.h src/kernel.h src/scrypt_mine.h src/pbkdf2.h src/serialize.h src/strlcpy.h src/main.h src/net.h src/key.h src/db.h src/walletdb.h src/script.h src/init.h src/irc.h src/mruset.h src/json/json_spirit_writer_template.h src/json/json_spirit_writer.h src/json/json_spirit_value.h src/json/json_spirit_utils.h src/json/json_spirit_stream_reader.h src/json/json_spirit_reader_template.h src/json/json_spirit_reader.h src/json/json_spirit_error_position.h src/json/json_spirit.h src/qt/clientmodel.h src/qt/guiutil.h src/qt/transactionrecord.h src/qt/guiconstants.h src/qt/optionsmodel.h src/qt/monitoreddatamapper.h src/qt/transactiondesc.h src/qt/transactiondescdialog.h src/qt/vaultcoinamountfield.h src/wallet.h src/keystore.h src/qt/transactionfilterproxy.h src/qt/transactionview.h src/qt/walletmodel.h src/vaultcoinrpc.h src/qt/overviewpage.h src/qt/csvmodelwriter.h src/crypter.h src/qt/sendcoinsentry.h src/qt/qvalidatedlineedit.h src/qt/vaultcoinunits.h src/qt/qvaluecombobox.h src/qt/askpassphrasedialog.h src/protocol.h src/qt/notificator.h src/qt/qtipcserver.h src/allocators.h src/ui_interface.h src/qt/rpcconsole.h src/version.h src/netbase.h src/clientversion.h src/hashblock.h src/sph_blake.h src/sph_groestl.h src/sph_jh.h src/sph_keccak.h src/sph_skein.h src/sph_types.h build/vaultcoin-qt1.0.0/ && $(COPY_FILE) --parents src/qt/vaultcoin.qrc build/vaultcoin-qt1.0.0/ && $(COPY_FILE) --parents src/qt/vaultcoin.cpp src/qt/vaultcoingui.cpp src/qt/transactiontablemodel.cpp src/qt/addresstablemodel.cpp src/qt/optionsdialog.cpp src/qt/sendcoinsdialog.cpp src/qt/addressbookpage.cpp src/qt/signverifymessagedialog.cpp src/qt/aboutdialog.cpp src/qt/editaddressdialog.cpp src/qt/vaultcoinaddressvalidator.cpp src/alert.cpp src/version.cpp src/sync.cpp src/util.cpp src/netbase.cpp src/key.cpp src/script.cpp src/main.cpp src/init.cpp src/net.cpp src/irc.cpp src/checkpoints.cpp src/addrman.cpp src/db.cpp src/walletdb.cpp src/qt/clientmodel.cpp src/qt/guiutil.cpp src/qt/transactionrecord.cpp src/qt/optionsmodel.cpp src/qt/monitoreddatamapper.cpp src/qt/transactiondesc.cpp src/qt/transactiondescdialog.cpp src/qt/vaultcoinstrings.cpp src/qt/vaultcoinamountfield.cpp src/wallet.cpp src/keystore.cpp src/qt/transactionfilterproxy.cpp src/qt/transactionview.cpp src/qt/walletmodel.cpp src/vaultcoinrpc.cpp src/rpcdump.cpp src/rpcnet.cpp src/rpcmining.cpp src/rpcwallet.cpp src/rpcblockchain.cpp src/rpcrawtransaction.cpp src/qt/overviewpage.cpp src/qt/csvmodelwriter.cpp src/crypter.cpp src/qt/sendcoinsentry.cpp src/qt/qvalidatedlineedit.cpp src/qt/vaultcoinunits.cpp src/qt/qvaluecombobox.cpp src/qt/askpassphrasedialog.cpp src/protocol.cpp src/qt/notificator.cpp src/qt/qtipcserver.cpp src/qt/rpcconsole.cpp src/noui.cpp src/kernel.cpp src/scrypt-x86.S src/scrypt-x86_64.S src/scrypt_mine.cpp src/pbkdf2.cpp src/aes_helper.c src/blake.c src/groestl.c src/jh.c src/keccak.c src/skein.c build/vaultcoin-qt1.0.0/ && $(COPY_FILE) --parents src/qt/forms/sendcoinsdialog.ui src/qt/forms/addressbookpage.ui src/qt/forms/signverifymessagedialog.ui src/qt/forms/aboutdialog.ui src/qt/forms/editaddressdialog.ui src/qt/forms/transactiondescdialog.ui src/qt/forms/overviewpage.ui src/qt/forms/sendcoinsentry.ui src/qt/forms/askpassphrasedialog.ui src/qt/forms/rpcconsole.ui src/qt/forms/optionsdialog.ui build/vaultcoin-qt1.0.0/ && $(COPY_FILE) --parents src/qt/locale/vaultcoin_en.ts src/qt/locale/vaultcoin_ru.ts build/vaultcoin-qt1.0.0/ && (cd `dirname build/vaultcoin-qt1.0.0` && $(TAR) vaultcoin-qt1.0.0.tar vaultcoin-qt1.0.0 && $(COMPRESS) vaultcoin-qt1.0.0.tar) && $(MOVE) `dirname build/vaultcoin-qt1.0.0`/vaultcoin-qt1.0.0.tar.gz . && $(DEL_FILE) -r build/vaultcoin-qt1.0.0
...
/home/luke/Downloads/VaultCoin/build/build.h: FORCE
	cd /home/luke/Downloads/VaultCoin; /bin/sh share/genbuild.sh /home/luke/Downloads/VaultCoin/build/build.h
...
compiler_TSQM_make_all: src/qt/locale/vaultcoin_en.qm src/qt/locale/vaultcoin_ru.qm
compiler_TSQM_clean:
	-$(DEL_FILE) src/qt/locale/vaultcoin_en.qm src/qt/locale/vaultcoin_ru.qm
src/qt/locale/vaultcoin_en.qm: src/qt/locale/vaultcoin_en.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/vaultcoin_en.ts -qm src/qt/locale/vaultcoin_en.qm

src/qt/locale/vaultcoin_ru.qm: src/qt/locale/vaultcoin_ru.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/vaultcoin_ru.ts -qm src/qt/locale/vaultcoin_ru.qm

compiler_moc_header_make_all: build/moc_vaultcoingui.cpp build/moc_transactiontablemodel.cpp build/moc_addresstablemodel.cpp build/moc_optionsdialog.cpp build/moc_sendcoinsdialog.cpp build/moc_addressbookpage.cpp build/moc_signverifymessagedialog.cpp build/moc_aboutdialog.cpp build/moc_editaddressdialog.cpp build/moc_vaultcoinaddressvalidator.cpp build/moc_clientmodel.cpp build/moc_guiutil.cpp build/moc_optionsmodel.cpp build/moc_monitoreddatamapper.cpp build/moc_transactiondesc.cpp build/moc_transactiondescdialog.cpp build/moc_vaultcoinamountfield.cpp build/moc_transactionfilterproxy.cpp build/moc_transactionview.cpp build/moc_walletmodel.cpp build/moc_overviewpage.cpp build/moc_csvmodelwriter.cpp build/moc_sendcoinsentry.cpp build/moc_qvalidatedlineedit.cpp build/moc_qvaluecombobox.cpp build/moc_askpassphrasedialog.cpp build/moc_notificator.cpp build/moc_rpcconsole.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) build/moc_vaultcoingui.cpp build/moc_transactiontablemodel.cpp build/moc_addresstablemodel.cpp build/moc_optionsdialog.cpp build/moc_sendcoinsdialog.cpp build/moc_addressbookpage.cpp build/moc_signverifymessagedialog.cpp build/moc_aboutdialog.cpp build/moc_editaddressdialog.cpp build/moc_vaultcoinaddressvalidator.cpp build/moc_clientmodel.cpp build/moc_guiutil.cpp build/moc_optionsmodel.cpp build/moc_monitoreddatamapper.cpp build/moc_transactiondesc.cpp build/moc_transactiondescdialog.cpp build/moc_vaultcoinamountfield.cpp build/moc_transactionfilterproxy.cpp build/moc_transactionview.cpp build/moc_walletmodel.cpp build/moc_overviewpage.cpp build/moc_csvmodelwriter.cpp build/moc_sendcoinsentry.cpp build/moc_qvalidatedlineedit.cpp build/moc_qvaluecombobox.cpp build/moc_askpassphrasedialog.cpp build/moc_notificator.cpp build/moc_rpcconsole.cpp
build/moc_vaultcoingui.cpp: src/qt/vaultcoingui.h
	/usr/lib/x86_64-linux-gnu/qt4/bin/moc $(DEFINES) $(INCPATH) src/qt/vaultcoingui.h -o build/moc_vaultcoingui.cpp
...
build/moc_vaultcoinaddressvalidator.cpp: src/qt/vaultcoinaddressvalidator.h
	/usr/lib/x86_64-linux-gnu/qt4/bin/moc $(DEFINES) $(INCPATH) src/qt/vaultcoinaddressvalidator.h -o build/moc_vaultcoinaddressvalidator.cpp
...
build/moc_vaultcoinamountfield.cpp: src/qt/vaultcoinamountfield.h
	/usr/lib/x86_64-linux-gnu/qt4/bin/moc $(DEFINES) $(INCPATH) src/qt/vaultcoinamountfield.h -o build/moc_vaultcoinamountfield.cpp
...
compiler_rcc_make_all: qrc_vaultcoin.cpp
compiler_rcc_clean:
	-$(DEL_FILE) qrc_vaultcoin.cpp
qrc_vaultcoin.cpp: src/qt/vaultcoin.qrc \
		src/qt/locale/vaultcoin_ru.qm \
		src/qt/locale/vaultcoin_en.qm \
		...
		src/qt/res/icons/vaultcoin-128.png \
		...
		src/qt/res/icons/vaultcoin-16.png \
	...
	/usr/lib/x86_64-linux-gnu/qt4/bin/rcc -name vaultcoin src/qt/vaultcoin.qrc -o qrc_vaultcoin.cpp
...
build/vaultcoin.o: src/qt/vaultcoin.cpp src/qt/vaultcoingui.h \
		src/qt/clientmodel.h \
		src/qt/walletmodel.h \
		src/allocators.h \
		src/qt/optionsmodel.h \
	...
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/vaultcoin.o src/qt/vaultcoin.cpp

build/vaultcoingui.o: src/qt/vaultcoingui.cpp src/qt/vaultcoingui.h \
		src/qt/transactiontablemodel.h \
	...
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/vaultcoingui.o src/qt/vaultcoingui.cpp
...
build/vaultcoinaddressvalidator.o: src/qt/vaultcoinaddressvalidator.cpp src/qt/vaultcoinaddressvalidator.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/vaultcoinaddressvalidator.o src/qt/vaultcoinaddressvalidator.cpp
...
build/vaultcoinstrings.o: src/qt/vaultcoinstrings.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/vaultcoinstrings.o src/qt/vaultcoinstrings.cpp

build/vaultcoinamountfield.o: src/qt/vaultcoinamountfield.cpp src/qt/vaultcoinamountfield.h \
		src/qt/qvaluecombobox.h \
		src/qt/vaultcoinunits.h \
		src/qt/guiconstants.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/vaultcoinamountfield.o src/qt/vaultcoinamountfield.cpp
...
build/vaultcoinrpc.o: src/vaultcoinrpc.cpp src/init.h \
		src/wallet.h \
		src/main.h \
		src/bignum.h \
		src/util.h \
		...
		src/json/json_spirit_utils.h \
		src/checkpoints.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/vaultcoinrpc.o src/vaultcoinrpc.cpp
...
build/vaultcoinunits.o: src/qt/vaultcoinunits.cpp src/qt/vaultcoinunits.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/vaultcoinunits.o src/qt/vaultcoinunits.cpp
...
build/moc_vaultcoingui.o: build/moc_vaultcoingui.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/moc_vaultcoingui.o build/moc_vaultcoingui.cpp
...
build/moc_vaultcoinaddressvalidator.o: build/moc_vaultcoinaddressvalidator.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/moc_vaultcoinaddressvalidator.o build/moc_vaultcoinaddressvalidator.cpp
...
build/moc_vaultcoinamountfield.o: build/moc_vaultcoinamountfield.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/moc_vaultcoinamountfield.o build/moc_vaultcoinamountfield.cpp
...
build/qrc_vaultcoin.o: qrc_vaultcoin.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/qrc_vaultcoin.o qrc_vaultcoin.cpp
