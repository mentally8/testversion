...
#ifndef _VAULTCOINRPC_H_
#define _VAULTCOINRPC_H_ 1
...
enum RPCErrorCode
{
    ...
    // P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  // Vaultcoin is not connected
...
/**
 * Vaultcoin RPC command dispatcher.
 */
class CRPCTable
{
private:
