...
#ifndef VAULTCOIN_MAIN_H
#define VAULTCOIN_MAIN_H
...
static const int BLOCK_TIME = 90; // 90s block times
static const int BLOCKS_PER_DAY = (60 * 60 * 24) / BLOCK_TIME; // 960 blocks
static const int LAST_POW_BLOCK = BLOCKS_PER_DAY * 3; // 3 day PoW period
...
static const int64 COIN_YEAR_REWARD = 20000 * COIN;	// 200% annual interest
static const int64 MIN_TXOUT_AMOUNT = MIN_TX_FEE;

static const int STAKE_MIN_AGE_SWITCH_BLOCK = 3450;
static const unsigned int STAKE_MIN_AGE_OLD          = 60 * 60 * 24 * 2; // 2 days
static const unsigned int STAKE_MIN_AGE_POST_3450    = 60 * 10 ;      // 10 minutes
...
static const uint256 hashGenesisBlock("0000086ef4c4ae547cb9cf84958026fb88e0e381abd7b8f6f00fe84f805fc75b");
static const uint256 hashGenesisBlockTestNet("000008461d3310ac6e14330cedade7c0792def3fbb656bb92408511018842ada");
...
public:
    ...
    */
    ...
    /** Amount of vaultcoins spent by this transaction.
    ...
    /** Amount of vaultcoins coming in to this transaction
    ...
    bool GetCoinAge(CTxDB& txdb, uint64& nCoinAge, const int nHeight) const;  // ppcoin: get transaction coin age
