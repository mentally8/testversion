 ...
 * The Vaultcoin Developers 2011-2012
 */
#include "vaultcoingui.h"
...
#ifndef Q_OS_MAC
    qApp->setWindowIcon(QIcon(":icons/vaultcoin"));
    setWindowIcon(QIcon(":icons/vaultcoin"));
#else
...
void VaultcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a Vaultcoin address"));
    ...
    aboutAction = new QAction(QIcon(":/icons/vaultcoin"), tr("&About Vaultcoin"), this);
    aboutAction->setToolTip(tr("Show information about Vaultcoin"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/trolltech/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for Vaultcoin"));
    optionsAction->setMenuRole(QAction::PreferencesRole);
    toggleHideAction = new QAction(QIcon(":/icons/vaultcoin"), tr("&Show / Hide"), this);
...
void VaultcoinGUI::createMenuBar()
{
#ifdef Q_OS_MAC
...
void VaultcoinGUI::createToolBars()
{
...
void VaultcoinGUI::setClientModel(ClientModel *clientModel)
{
...
#ifndef Q_OS_MAC
            qApp->setWindowIcon(QIcon(":icons/vaultcoin_testnet"));
            setWindowIcon(QIcon(":icons/vaultcoin_testnet"));
#else
            MacDockIconHandler::instance()->setIcon(QIcon(":icons/vaultcoin_testnet"));
#endif
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("Vaultcoin client") + QString(" ") + tr("[testnet]"));
...
void VaultcoinGUI::setWalletModel(WalletModel *walletModel)
{
...
void VaultcoinGUI::createTrayIcon()
{
    QMenu *trayIconMenu;
#ifndef Q_OS_MAC
...
#ifndef Q_OS_MAC
void VaultcoinGUI::trayIconActivated(QSystemTrayIcon::ActivationReason reason)
{
...
void VaultcoinGUI::optionsClicked()
{
...
void VaultcoinGUI::aboutClicked()
{
    AboutDialog dlg;
...
void VaultcoinGUI::setNumConnections(int count)
{
    QString icon;
    switch(count)
    {
...
void VaultcoinGUI::setNumBlocks(int count, int nTotalBlocks)
{
...
void VaultcoinGUI::changeEvent(QEvent *e)
{
...
void VaultcoinGUI::closeEvent(QCloseEvent *event)
{
    if(clientModel)
    {
#ifndef Q_OS_MAC // Ignored on Mac
...
void VaultcoinGUI::askFee(qint64 nFeeRequired, bool *payFee)
{
    QString strMessage =
        tr("This transaction is over the size limit.  You can still send it for a fee of %1, "
          "which goes to the nodes that process your transaction and helps to support the network.  "
          "Do you want to pay the fee?").arg(
                VaultcoinUnits::formatWithUnit(VaultcoinUnits::BTC, nFeeRequired));
...
void VaultcoinGUI::incomingTransaction(const QModelIndex & parent, int start, int end)
{
        ...
        notificator->notify(Notificator::Information,
                            (amount)<0 ? tr("Sent transaction") :
                              ...
                              tr("Date: %1\n"
                                 ...
                                 "Address: %4\n")
                              .arg(date)
                              .arg(VaultcoinUnits::formatWithUnit(walletModel->getOptionsModel()->getDisplayUnit(), amount, true))
                              .arg(type)
                              .arg(address), icon);
    }
}

void VaultcoinGUI::gotoOverviewPage()
{
...
void VaultcoinGUI::gotoHistoryPage()
{
...
void VaultcoinGUI::gotoAddressBookPage()
{
...
void VaultcoinGUI::gotoReceiveCoinsPage()
{
...
void VaultcoinGUI::gotoSendCoinsPage()
{
...
void VaultcoinGUI::gotoSignMessageTab(QString addr)
{
...
void VaultcoinGUI::gotoVerifyMessageTab(QString addr)
{
...
void VaultcoinGUI::dragEnterEvent(QDragEnterEvent *event)
{
    // Accept only URIs
...
void VaultcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid Vaultcoin address or malformed URI parameters."));
    }

    event->acceptProposedAction();
}

void VaultcoinGUI::handleURI(QString strURI)
{
    // URI has to be valid
...
void VaultcoinGUI::setEncryptionStatus(int status)
{
    switch(status)
    {
...
void VaultcoinGUI::encryptWallet(bool status)
{
    if(!walletModel)
        return;
...
void VaultcoinGUI::unlockWallet()
{
    if(!walletModel)
        return;
    // Unlock wallet when requested by wallet model
...
void VaultcoinGUI::showNormalIfMinimized(bool fToggleHidden)
{
...
void VaultcoinGUI::toggleHidden()
{
