...
{
    return GetBoolArg("-testnet", false) ? 16996 : 6996;
}
...
Value stop(const Array& params, bool fHelp)
{
    if (fHelp || params.size() > 1)
        throw runtime_error(
            ...
            "Stop Vaultcoin server (and possibly override the detachdb config value).");
...
//
// JSON-RPC protocol.  Vaultcoin speaks version 1.0 for maximum compatibility,
...
void ThreadRPCServer(void* parg)
{
    ...
    RenameThread("vaultcoin-rpclist");
...
void ThreadRPCServer3(void* parg)
{
    ...
    RenameThread("vaultcoin-rpchand");
